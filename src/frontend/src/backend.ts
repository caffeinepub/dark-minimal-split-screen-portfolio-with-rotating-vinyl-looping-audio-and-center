...
import type { ExternalBlob as _ExternalBlob, ImageMetadata as _ImageMetadata, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getImage(arg0: bigint): Promise<ImageMetadata | null> {
        if (this.processError) {
            try {
    ...
    async listImages(): Promise<Array<[bigint, ImageMetadata]>> {
        if (this.processError) {
            try {
    ...
    async uploadImage(arg0: ExternalBlob, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadImage(await to_candid_ExternalBlob_n19(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ImageMetadata_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ImageMetadata): Promise<ImageMetadata> {
...
async function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ImageMetadata]): Promise<ImageMetadata | null> {
    return value.length === 0 ? null : await from_candid_ImageMetadata_n14(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_tuple_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [bigint, _ImageMetadata]): Promise<[bigint, ImageMetadata]> {
    return [
        value[0],
        await from_candid_ImageMetadata_n14(_uploadFile, _downloadFile, value[1])
    ];
}
...
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[bigint, _ImageMetadata]>): Promise<Array<[bigint, ImageMetadata]>> {
